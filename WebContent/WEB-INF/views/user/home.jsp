					...
					<a>
						<div class="card-body d-flex flex-column justify-content-between">
							<div>
								...
								<div class="123"     style="text-align: center;">
								<%-- <ul id="123" style="float:left;">
									<li style="width:50%; display:block;">
									<a class="btn btn-primary w-100 btn-buy "
										href="/JEWELRY6/productDetail/${product.getId()}.htm">Xem</a>
									</li>
									<li style=" display:block;">
									<a class="btn btn-primary w-100 btn-buy ${product.quantity <= 0 ? 'disabled' : ''}"
										href="cart/add.htm?productId=${product.id}">Mua ngay</a>
									</li>
								</ul> --%>
									<a class="btn btn-primary w-100 btn-buy " style="width:auto!important"
										href="/JEWELRY6/productDetail/${product.getId()}.htm">Xem</a>	
									<a class="btn btn-primary w-100 btn-buy ${product.quantity <= 0 ? 'disabled' : ''}"
