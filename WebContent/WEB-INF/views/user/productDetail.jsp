                    ...
                    <div class="product__details__text">
                        ...
                        <c:if test="${u != null}">
              				<c:if test="${pd.getQuantity() > 0}">
                           		<a href="cart/add.htm?productId=${pd.id}" class="buy-btn" style="text-decoration:none;">Mua ngay</a>
                        	</c:if>
     					</c:if>
     					<c:if test="${u == null}">
              				<c:if test="${pd.getQuantity() > 0}">
                           		<a href="login.htm" class="buy-btn" style="text-decoration:none;">Mua ngay</a>
                        	</c:if>
     					</c:if>
